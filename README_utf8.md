...
- Red flag detection in suspicious job postings (14+ patterns)
...
- Detailed severity assessment (Low / Medium / High / Critical)
...
### NLP
- NLTK, SpaCy, TextBlob
- Sentiment analysis, readability scoring
...
- Input Layer: 514 features (500 TF-IDF + 14 engineered)
...
| `POST` | `/api/analyze` | Analyze a single job posting |
| `POST` | `/api/analyze-batch` | Analyze multiple job postings |
| `GET` | `/api/supported-portals` | List supported job portals |
| `GET` | `/api/test-analysis` | Test with sample data |
...
| `/how-it-works` | How the detection works |
